...
class Entertainment extends Component {
  ...
  async componentDidMount() {
    const url =
      "http://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=5eb1dc002c884411a1fec931c5f74be0";
    ...
    return (
      <div className="pt-5">
        <img
          ...
          src="https://pro-motivate.com/wp-content/uploads/2018/02/entertainment-banner.jpg"
          className="img-fluid"
