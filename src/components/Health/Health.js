...
class Health extends Component {
  ...
  async componentDidMount() {
    const url =
      "http://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=5eb1dc002c884411a1fec931c5f74be0";
    ...
    return (
      <div className="pt-5">
        <img
          ...
          src="https://www.bchu.org/Carousel/COVID%20Mental%20Health%20Web%20Banner.jpg"
          className="img-fluid"
