...
class Technology extends Component {
  ...
  async componentDidMount() {
    const url =
      "http://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=5eb1dc002c884411a1fec931c5f74be0";
    ...
    return (
      <div className="pt-5">
        <img
          ...
          src="https://www.nist.gov/sites/default/files/images/2019/04/02/nistcyber_banner-11.19.18-am.png"
          className="img-fluid"
